...
def get_colored_map(mat, collision_map, visited, visited_gt, goal,
    ...
    pal = sns.color_palette("Paired")#Paired


    current_palette = [(0.9, 0.9, 0.9)]# this is the ground truth map
    #colored = fill_color(colored, gt_map, current_palette[0])

    current_palette = [(235. / 255., 243. / 255., 1.)]#235. / 255., 243. / 255., 1.
    colored = fill_color(colored, explored, current_palette[0])

    green_palette = sns.light_palette("green")
    colored = fill_color(colored, mat, pal[2])  # mat is the pred map 2
    ...
    colored = fill_color(colored, visited, pal[4])#pal[4]
